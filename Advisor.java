...
public class Advisor {
	...
	static MyTableModel reportTableModel;
	static JTable table;
	static JScrollPane scrollPane; // scrollPane for table
	
	static String reportTableSelected="";
	...
	/**
	 * @wbp.nonvisual location=1218,187
	 */
			...
			public void actionPerformed(ActionEvent e) {
				...
				switch(lastTab){
					...
					case 1:
						...
						/**
						 * When view is pressed it instantiates a view object that holds a text area.
						 * This text area will be used to contains the report information rather that putting it all in a JOPtionPane
						 * 
						 * 
						 */
			...
			groupLayout.createParallelGroup(Alignment.LEADING)
				.addGroup(groupLayout.createSequentialGroup()
					.addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
						.addGroup(groupLayout.createSequentialGroup()
							.addGap(327)
							.addComponent(Add, GroupLayout.PREFERRED_SIZE, 120, GroupLayout.PREFERRED_SIZE)
							.addGap(18)
	 ...
	 */
	public static void initTableRecords(){
		Node node;
	...
	public static void initTableStuds(){
		Node node;
		tableModel.setColumnCount(0);
		tableModel.setRowCount(0);
